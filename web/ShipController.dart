...
import 'scripts/RelationshipType.dart';
...
void main() {
  ...
  cardsButton = querySelector("#allowCards");
  ...
  cardsButton.onClick.listen((e) => toggleCards());
...
List<RelationshipType> getAllowedRelationshipTypes() {
  ...
  if(allowCards) {
    ret.addAll(RelationshipType.CARDS);
  }
  if(allowDynamotions) {
